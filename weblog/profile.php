...
<body>
	<div id="header" style="margin-top: 60px;">
		<a href="index.php" style="text-decoration: none; color: red; background-color: yellow; padding: 10px;">Log Out</a> ||
		<a href="profileinfo.php" style="text-decoration: none; color: red; background-color: yellow; padding: 10px;">profile</a>
	</div>
	<?php
